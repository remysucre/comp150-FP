...
#endif
happyIn4 :: ([Production]) -> (HappyAbsSyn )
happyIn4 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn4 #-}
happyOut4 :: (HappyAbsSyn ) -> ([Production])
happyOut4 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut4 #-}
happyIn5 :: ([Production]) -> (HappyAbsSyn )
happyIn5 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn5 #-}
happyOut5 :: (HappyAbsSyn ) -> ([Production])
happyOut5 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut5 #-}
happyIn6 :: ([Production]) -> (HappyAbsSyn )
happyIn6 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn6 #-}
happyOut6 :: (HappyAbsSyn ) -> ([Production])
happyOut6 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut6 #-}
happyIn7 :: (Production) -> (HappyAbsSyn )
happyIn7 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn7 #-}
happyOut7 :: (HappyAbsSyn ) -> (Production)
...
{-# INLINE happyOut9 #-}
happyIn10 :: (Production) -> (HappyAbsSyn )
happyIn10 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn10 #-}
happyOut10 :: (HappyAbsSyn ) -> (Production)
happyOut10 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut10 #-}
happyIn11 :: ([Production]) -> (HappyAbsSyn )
happyIn11 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn11 #-}
happyOut11 :: (HappyAbsSyn ) -> ([Production])
happyOut11 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut11 #-}
happyIn12 :: (Production) -> (HappyAbsSyn )
happyIn12 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn12 #-}
happyOut12 :: (HappyAbsSyn ) -> (Production)
happyOut12 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut12 #-}
happyIn13 :: ([Production]) -> (HappyAbsSyn )
happyIn13 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn13 #-}
happyOut13 :: (HappyAbsSyn ) -> ([Production])
...
{-# INLINE happyOut15 #-}
happyIn16 :: ([Production]) -> (HappyAbsSyn )
happyIn16 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn16 #-}
happyOut16 :: (HappyAbsSyn ) -> ([Production])
...
{-# INLINE happyOut17 #-}
happyIn18 :: (Production) -> (HappyAbsSyn )
happyIn18 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn18 #-}
happyOut18 :: (HappyAbsSyn ) -> (Production)
...
{-# INLINE happyOut19 #-}
happyIn20 :: ([Production]) -> (HappyAbsSyn )
happyIn20 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn20 #-}
happyOut20 :: (HappyAbsSyn ) -> ([Production])
...
{-# INLINE happyOut21 #-}
happyIn22 :: ([Production]) -> (HappyAbsSyn )
happyIn22 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn22 #-}
happyOut22 :: (HappyAbsSyn ) -> ([Production])
happyOut22 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut22 #-}
happyIn23 :: (Production) -> (HappyAbsSyn )
happyIn23 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn23 #-}
happyOut23 :: (HappyAbsSyn ) -> (Production)
...
{-# INLINE happyOut29 #-}
happyIn30 :: (()) -> (HappyAbsSyn )
happyIn30 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn30 #-}
happyOut30 :: (HappyAbsSyn ) -> (())
happyOut30 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut30 #-}
happyIn31 :: (()) -> (HappyAbsSyn )
happyIn31 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn31 #-}
happyOut31 :: (HappyAbsSyn ) -> (())
happyOut31 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut31 #-}
happyIn32 :: ([Production]) -> (HappyAbsSyn )
happyIn32 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn32 #-}
happyOut32 :: (HappyAbsSyn ) -> ([Production])
happyOut32 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut32 #-}
happyIn33 :: ([Production]) -> (HappyAbsSyn )
happyIn33 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn33 #-}
happyOut33 :: (HappyAbsSyn ) -> ([Production])
happyOut33 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut33 #-}
happyIn34 :: (Production) -> (HappyAbsSyn )
happyIn34 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn34 #-}
happyOut34 :: (HappyAbsSyn ) -> (Production)
happyOut34 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut34 #-}
happyIn35 :: (Production) -> (HappyAbsSyn )
happyIn35 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn35 #-}
happyOut35 :: (HappyAbsSyn ) -> (Production)
happyOut35 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut35 #-}
happyIn36 :: ([Production]) -> (HappyAbsSyn )
happyIn36 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn36 #-}
happyOut36 :: (HappyAbsSyn ) -> ([Production])
...
{-# INLINE happyOut37 #-}
happyIn38 :: (Production) -> (HappyAbsSyn )
happyIn38 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn38 #-}
happyOut38 :: (HappyAbsSyn ) -> (Production)
happyOut38 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut38 #-}
happyIn39 :: (()) -> (HappyAbsSyn )
happyIn39 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn39 #-}
happyOut39 :: (HappyAbsSyn ) -> (())
happyOut39 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut39 #-}
happyIn40 :: (()) -> (HappyAbsSyn )
...
happyReduction_7 (happy_x_5 `HappyStk`
	...
	happyIn7
		 (ProdProduction happy_var_1 happy_var_2 happy_var_4
	) `HappyStk` happyRest}}}
...
happyReduction_25 (happy_x_5 `HappyStk`
	...
	happyIn16
		 (happyPrepare happy_var_2 happy_var_4
	) `HappyStk` happyRest}}
...
happyReduction_28 (happy_x_4 `HappyStk`
	...
	happyIn18
		 (ProdProduction happy_var_1 [] happy_var_4
	) `HappyStk` happyRest}}
...
happyReduction_70 (happy_x_4 `HappyStk`
	...
	happy_x_1 `HappyStk`
	happyRest)
	 = case happyOutTok happy_x_1 of { (CIdent' happy_var_1) -> 
	case happyOut36 happy_x_3 of { happy_var_3 -> 
	happyIn35
		 (ProdProduction happy_var_1 [] (ProdTerm [ProdFactor happy_var_3])
	) `HappyStk` happyRest}}
...
happyReduce_73 = happySpecReduce_0  32# happyReduction_73
happyReduction_73  =  happyIn36
		 ([]
	)
...
happyReduce_82 = happySpecReduce_0  36# happyReduction_82
happyReduction_82  =  happyIn40
		 (()
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	HappyInput -> cont 2#;
	YaccInput -> cont 3#;
	Ident' happy_dollar_dollar -> cont 4#;
	CIdent' happy_dollar_dollar -> cont 5#;
	SemiColon -> cont 6#;
	Colon -> cont 7#;
	DoubleColon -> cont 8#;
	DoublePercent -> cont 9#;
	Percent -> cont 10#;
	Bar -> cont 11#;
	OpenBrace -> cont 12#;
	ClosingBrace -> cont 13#;
	Dot -> cont 14#;
	Equal -> cont 15#;
	Plus -> cont 16#;
	OpenBrack -> cont 17#;
	ClosingBrack -> cont 18#;
	OpenParen -> cont 19#;
	ClosingParen -> cont 20#;
	Slash -> cont 21#;
	String' happy_dollar_dollar -> cont 22#;
	Symbol' happy_dollar_dollar -> cont 23#;
	Number' _ -> cont 24#;
	_ -> happyError' (tk:tks)
	}
...
ebnf2psParser tks = happyRunIdentity happySomeParser where
